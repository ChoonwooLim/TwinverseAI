...
from routers import auth, admin, docs, skills, plugins, boards, comments, files, news, ps2_spawner, npc, npc_agent, admin_openclaw
...
def _seed_docs():
    ...
    DOC_FILES = {
        ...
        "pixel-streaming-server": ("픽셀스트리밍 서버", "pixel-streaming-server.md"),
